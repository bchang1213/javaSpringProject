(function () {
	...
	if (supportsVideo) {
		...
		if (document.addEventListener) {
			...
			// Add event listeners for video player specific events
			...
			//Scrub video as user scrolls through video progress bar
			progress.addEventListener('mousedown', function(e){
				...
				progress.onmousemove = function(e){
					var pos = (e.clientX  - (this.offsetLeft + this.offsetParent.offsetLeft + this.offsetParent.offsetParent.offsetLeft)) / this.offsetWidth;
					console.log(pos);
					video.currentTime = pos * video.duration;
				}
